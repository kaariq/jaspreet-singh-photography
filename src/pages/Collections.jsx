    ...
    <main className="pb-12 sm:pb-20">
      ...
      <section className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 mt-6 sm:mt-12">
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-3 sm:gap-6 lg:gap-8 mb-10 sm:mb-16">
          {COLLECTIONS.map((c, i) => (
            <Link to={`/collections/${c.tag.toLowerCase().replace(/\s+/g,'-')}`} key={c.title} className={`group relative overflow-hidden bg-rose-pale block aspect-[4/5] sm:aspect-[4/3] ${i%2===0 ? 'lg:col-span-7' : 'lg:col-span-5'}`}>
